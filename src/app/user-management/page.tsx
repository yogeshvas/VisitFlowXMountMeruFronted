...
import { ChevronLeft, UserPlus, BarChart2, Calendar, Target, Search, User, ArrowLeft, SquareCheckBig, ChartArea, UserRoundSearch } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col max-w-xl mx-auto">
      ...
      <div className="p-4 grid grid-cols-2 gap-4 bg-white">
        <Card className="border-gray-200 hover:border-black" onClick={()=>handleNavigate('/user-management/add-user')}>
          <CardContent className="p-6 flex flex-col items-center justify-center">
            <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center mb-3">
              <UserPlus className="h-6 w-6 text-black" />
            </div>
            <span className="text-sm font-medium text-black">Add A User</span>
          </CardContent>
        </Card>
